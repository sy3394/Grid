/*************************************************************************************
    ...
    Source file: ./tests/Test_rfthmc.cc
...
int main (int argc, char ** argv)
{
  ...
  std::vector<Smear_Stout<PeriodicGimplR> *> Stouts1S = {&SmearerS};
  std::vector<int> mask_types1S{1};
  ...
  JacobianAction<PeriodicGimplR, SmearedConfigurationRect<PeriodicGimplR> > Jacobian1R(&SmartConfig1R);
  JacobianAction<PeriodicGimplR, SmearedConfigurationRect<PeriodicGimplR> > Jacobian1S(&SmartConfig1S);
  JacobianAction<PeriodicGimplR, SmearedConfigurationRect<PeriodicGimplR> > JacobianR(&SmartConfigR);
  JacobianAction<PeriodicGimplR> JacobianS(&SmartConfigS);
