...
#
# --comp_file (optional): qlat stochastic DWF TCD reference fields (HDF5).
#   Located in visualisation/data/topo_field_<idx>.h5 (converted by pickle_to_hdf5.py).
...
COMP_DIR=$(cd "$(dirname "$0")/.." && pwd)/data   # qlat reference HDF5 files: visualisation/data/topo_field_<idx>.h5
